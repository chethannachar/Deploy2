...
function Login(){
    ...
    return(
        ...
        <form > 
            ...
            <input type="text" onChange={aclasses}value={attended} placeholder="Classes Attended"></input>
            <input type="text" onChange={tclasses}value={held} placeholder="Classes Held "></input>
        </form>
